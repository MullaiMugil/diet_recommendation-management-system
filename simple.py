...
def Weight_Loss():
    ...
    datafin=pd.read_csv('C:\Users\MullaiMugil\Downloads\miniproject-main (1)\miniproject-main\inputfin.csv')
...
def Weight_Gain():
    ...
    USER_INP = simpledialog.askstring(title="Food Timing" prompt="Enter 1 for Breakfast, 2 for Lunch and 3 for Dinner")
